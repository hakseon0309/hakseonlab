...
function AberrusBarInsertStrategy() {
    return (
        <div className="aberrusBarInsert">
            ...
            <p>
                전투중 크게 두 가지의 디버프를 조심하면 됩니다.
                원형 디버프인 공포의 균열 대상자가 되면 외곽에 바닥을 깔고 오면 됩니다.
                공포의 균열에서 튀어나오는 바닥은 가장 가까운 대상을 추적하는 레이저가 생성되고,
                대상자는 공포의 균열 바닥으로 유도해 만나게 되면 레이저는 제거됩니다.
                한번 사용한 공포의 균열 바닥은 더 이상 레이저를 제거할 수 없습니다.
            </p>
            <p>
